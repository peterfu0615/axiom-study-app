...
const dimensions: Array<{ value: HorizonTagType; label: string; description: string }> = [
  { value: 'knowledge', label: '知识点', description: '仅显示当前教材中的知识点' },
